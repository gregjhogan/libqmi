                ...
                GCancellable *cancellable)
{
    ...
    if (start_flag) {
        ...
        qmi_message_loc_start_input_set_minimum_interval_between_final_position_reports (input, 1000, NULL);
        qmi_message_loc_start_input_set_minimum_interval_between_intermediate_position_reports (input, 1000, NULL);
