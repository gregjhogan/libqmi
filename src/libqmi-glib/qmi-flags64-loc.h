 ...
 * @QMI_LOC_EVENT_REGISTRATION_FLAG_GNSS_MEASUREMENT_REPORT: GNSS satellite raw measurements
 * @QMI_LOC_EVENT_REGISTRATION_FLAG_GNSS_SV_POLY_REPORT: GNSS satellite ephemeris data
 *
...
typedef enum { /*< since=1.22 >*/
    ...
    QMI_LOC_EVENT_REGISTRATION_FLAG_GNSS_MEASUREMENT_REPORT            = 1 << 24,
    QMI_LOC_EVENT_REGISTRATION_FLAG_GNSS_SV_POLY_REPORT                = 1 << 25,
} QmiLocEventRegistrationFlag;
